...
var lado = 1; //variable del lado del cubo
var t = 1; // Variable para trasladar los cubos
...
for (var i = 0; i < n; i++) {
    Cubo[i] = cubo(t, t, t, color[i]);
    Cubo[i].position.x = t/2; 
    Cubo[i].position.y = t/2;
    Cubo[i].position.z = t/2;
  t =t/2; // Se divide a la mitad el valor del cubo hasta que se complete el ciclo
}
